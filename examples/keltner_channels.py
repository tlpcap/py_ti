...
# add a 20 period Keltner Channels with SMA smoothing to the Dataframe that was passed in
ti.keltner_channel(data, add_col=True) # same as ti.keltner_channel(data, n=20, add_col=True)

# add a 14 period Keltner Channels with Wilders MA smoothing to the Dataframe that was passed in
